...
func (cs *CaMKIIState) Init() {
	...
	if TheOpts.InitBaseline {
		if TheOpts.UseDAPK1 {
			vol := float64(CytVol)
			cs.Cyt.Ca[0].CaM_CaMKII = chem.CoToN(0.4025, vol)
			cs.Cyt.Ca[0].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.Cyt.Ca[1].CaM_CaMKII = chem.CoToN(0.005162, vol)
			cs.Cyt.Ca[1].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.Cyt.Ca[2].CaM_CaMKII = chem.CoToN(3.63e-05, vol)
			cs.Cyt.Ca[2].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.Cyt.Ca[3].CaM_CaMKII = chem.CoToN(4.853e-06, vol)
			cs.Cyt.Ca[3].CaM_CaMKIIP = chem.CoToN(0, vol)
			...
			cs.Cyt.CaMKII = chem.CoToN(19.26, vol)
			cs.Cyt.CaMKIIP = chem.CoToN(0, vol)
			cs.Cyt.N2B_CaMKII = chem.CoToN(0, vol)
			cs.Cyt.N2B_CaMKIIP = chem.CoToN(0, vol)
			cs.Cyt.PP1Thr286C = chem.CoToN(0, vol)
			cs.Cyt.PP2AThr286C = chem.CoToN(0, vol)
			vol = PSDVol
			cs.PSD.Ca[0].CaM_CaMKII = chem.CoToN(0.3676, vol)
			cs.PSD.Ca[0].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.Ca[1].CaM_CaMKII = chem.CoToN(0.004715, vol)
			cs.PSD.Ca[1].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.Ca[2].CaM_CaMKII = chem.CoToN(3.332e-05, vol)
			cs.PSD.Ca[2].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.Ca[3].CaM_CaMKII = chem.CoToN(4.868e-06, vol)
			cs.PSD.Ca[3].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.N2B[0].CaM_CaMKII = chem.CoToN(1.631, vol)
			cs.PSD.N2B[0].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.N2B[1].CaM_CaMKII = chem.CoToN(0.02088, vol)
			cs.PSD.N2B[1].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.N2B[2].CaM_CaMKII = chem.CoToN(0.000139, vol)
			cs.PSD.N2B[2].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.N2B[3].CaM_CaMKII = chem.CoToN(0.0001851, vol)
			cs.PSD.N2B[3].CaM_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.CaMKII = chem.CoToN(19.3, vol)
			cs.PSD.CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.N2B_CaMKII = chem.CoToN(0.001014, vol)
			cs.PSD.N2B_CaMKIIP = chem.CoToN(0, vol)
			cs.PSD.PP1Thr286C = chem.CoToN(0, vol)
			cs.PSD.PP2AThr286C = chem.CoToN(0, vol)
		} else {
			vol := float64(CytVol)
