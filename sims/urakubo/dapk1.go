...
func (cs *DAPK1State) Init() {
	...
	if TheOpts.InitBaseline {
		vol := float64(CytVol)
		cs.Cyt.Ca[0].CaM_DAPK1 = chem.CoToN(0.001461, vol)
		cs.Cyt.Ca[0].CaM_DAPK1P = chem.CoToN(0.5958, vol)
		cs.Cyt.Ca[1].CaM_DAPK1 = chem.CoToN(2.24e-05, vol)
		cs.Cyt.Ca[1].CaM_DAPK1P = chem.CoToN(0.02959, vol)
		cs.Cyt.Ca[2].CaM_DAPK1 = chem.CoToN(8.133e-07, vol)
		cs.Cyt.Ca[2].CaM_DAPK1P = chem.CoToN(0.001905, vol)
		cs.Cyt.Ca[3].CaM_DAPK1 = chem.CoToN(1.429e-06, vol)
		cs.Cyt.Ca[3].CaM_DAPK1P = chem.CoToN(0.000392, vol)
		...
		cs.Cyt.DAPK1 = chem.CoToN(0.09693, vol)
		cs.Cyt.DAPK1P = chem.CoToN(19.27, vol)
		cs.Cyt.N2B_DAPK1 = chem.CoToN(0, vol)
		cs.Cyt.N2B_DAPK1P = chem.CoToN(0, vol)
		cs.Cyt.CaNSer308C = chem.CoToN(0.0002841, vol)
		cs.Cyt.PP2ASer308C = chem.CoToN(0.03445, vol)
		vol = PSDVol
		cs.PSD.Ca[0].CaM_DAPK1 = chem.CoToN(0.001143, vol)
		cs.PSD.Ca[0].CaM_DAPK1P = chem.CoToN(0.5959, vol)
		cs.PSD.Ca[1].CaM_DAPK1 = chem.CoToN(1.753e-05, vol)
		cs.PSD.Ca[1].CaM_DAPK1P = chem.CoToN(0.02959, vol)
		cs.PSD.Ca[2].CaM_DAPK1 = chem.CoToN(6.801e-07, vol)
		cs.PSD.Ca[2].CaM_DAPK1P = chem.CoToN(0.001905, vol)
		cs.PSD.Ca[3].CaM_DAPK1 = chem.CoToN(1.306e-06, vol)
		cs.PSD.Ca[3].CaM_DAPK1P = chem.CoToN(0.0003921, vol)
		cs.PSD.N2B[0].CaM_DAPK1 = chem.CoToN(0.006541, vol)
		cs.PSD.N2B[0].CaM_DAPK1P = chem.CoToN(1.593e-06, vol)
		cs.PSD.N2B[1].CaM_DAPK1 = chem.CoToN(8.476e-05, vol)
		cs.PSD.N2B[1].CaM_DAPK1P = chem.CoToN(2.105e-07, vol)
		cs.PSD.N2B[2].CaM_DAPK1 = chem.CoToN(6.894e-07, vol)
		cs.PSD.N2B[2].CaM_DAPK1P = chem.CoToN(1.924e-07, vol)
		cs.PSD.N2B[3].CaM_DAPK1 = chem.CoToN(1.741e-07, vol)
		cs.PSD.N2B[3].CaM_DAPK1P = chem.CoToN(1.921e-07, vol)
		cs.PSD.DAPK1 = chem.CoToN(0.0984, vol)
		cs.PSD.DAPK1P = chem.CoToN(19.26, vol)
		cs.PSD.N2B_DAPK1 = chem.CoToN(0.0006504, vol)
		cs.PSD.N2B_DAPK1P = chem.CoToN(1.938e-07, vol)
		cs.PSD.CaNSer308C = chem.CoToN(0.0001435, vol)
		cs.PSD.PP2ASer308C = chem.CoToN(0.1378, vol)
	}
	cs.Cyt.ActiveK()
	cs.PSD.ActiveK()
}
